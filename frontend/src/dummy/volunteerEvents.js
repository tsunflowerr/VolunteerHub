...
export const volunteerEvents = [
  {
    _id: '1',
    title: "HALLOQWEEN party @ Charlie's Nightclub DENVER",
    description:
    ...
    hostName: 'AspenOUT Community Fund',
    hostAvatar:
  ...
  {
    _id: '2',
    title: 'Dwell Ophan Care: Make Meals for Children in Foster Care',
    description:
  ...
  {
    _id: '3',
    title: 'Dwell Ophan Care: Organize Donations for Foster Children',
  ...
  },
  {
    ...
    hostName: 'Ocean Conservation Society',
    hostAvatar:
  ...
  },
  {
    ...
    hostName: 'Urban Farming Initiative',
    hostAvatar:
